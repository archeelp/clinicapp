...
function reverseGeocode(coords, requestOptions) {
    var options = tslib_1.__assign({ endpoint: helpers_1.ARCGIS_ONLINE_GEOCODING_URL, params: {} }, requestOptions);
    ...
    return arcgis_rest_request_1.request(arcgis_rest_request_1.cleanUrl(options.endpoint) + "/reverseGeocode", options);
}
